...
from socialNet_backend.app import celery    # noqa  # make sure Celery is loaded
from socialNet_backend.app.configuration import config    # noqa
from socialNet_backend.app.logging import setup_logging
from socialNet_backend.app.redis import setup_redis
from socialNet_backend.db.base import initialize_database
