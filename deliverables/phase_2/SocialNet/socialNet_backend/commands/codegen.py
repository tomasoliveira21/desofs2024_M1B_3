...
from socialNet_backend.utils.string import camel_to_snake_case


REPO_TEMPLATE = """
from socialNet_backend.db.session import get_session, session_commit
from socialNet_backend.db.repository.utils import validate_write_fields, set_write_fields, instance_or_id
from socialNet_backend.db.repository.exceptions import CreateError, UpdateError
from socialNet_backend.db.models import {cls}
from socialnet.sqlalchemy.utils import handle_db_not_found
...
def gen_repo_code(classname, module):
    ...
    if module:
        filepath = f'socialNet_backend/db/repository/{module}.py'
