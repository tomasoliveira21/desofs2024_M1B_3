...
from socialnet.lib.config import Configuration
from socialnet.lib.config.values import Value, BooleanValue, IntegerValue
...
class Base(Configuration):
    ...
    DOMAIN = Value('socialnet.localdev')
    ...
    ROOT_DOMAIN = Value('socialnet.localdev')

    STATIC_BASE_URL = Value('/static')

    DATABASE_URL = Value('postgres://root:@postgres/socialNet_backend')
