...
# source: socialNet_backend_protobuf/common.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='socialNet_backend_protobuf/common.proto',
  package='socialNet_backend',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\'socialNet_backend_protobuf/common.proto\x12\x11\x61lvinchow_backend\"\x17\n\tIdRequest\x12\n\n\x02id\x18\x01 \x01(\x04\"!\n\x0eSimpleResponse\x12\x0f\n\x07success\x18\x01 \x01(\x08\x62\x06proto3'
)
...
_IDREQUEST = _descriptor.Descriptor(
  name='IdRequest',
  full_name='socialNet_backend.IdRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='socialNet_backend.IdRequest.id', index=0,
...
_SIMPLERESPONSE = _descriptor.Descriptor(
  name='SimpleResponse',
  full_name='socialNet_backend.SimpleResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='socialNet_backend.SimpleResponse.success', index=0,
...
IdRequest = _reflection.GeneratedProtocolMessageType('IdRequest', (_message.Message,), {
  ...
  '__module__' : 'socialNet_backend_protobuf.common_pb2'
  # @@protoc_insertion_point(class_scope:socialNet_backend.IdRequest)
  })
...
SimpleResponse = _reflection.GeneratedProtocolMessageType('SimpleResponse', (_message.Message,), {
  ...
  '__module__' : 'socialNet_backend_protobuf.common_pb2'
  # @@protoc_insertion_point(class_scope:socialNet_backend.SimpleResponse)
  })
