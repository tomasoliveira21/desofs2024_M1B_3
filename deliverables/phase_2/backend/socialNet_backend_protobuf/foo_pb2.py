...
# source: socialNet_backend_protobuf/foo.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='socialNet_backend_protobuf/foo.proto',
  package='socialNet_backend',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n$socialNet_backend_protobuf/foo.proto\x12\x11\x61lvinchow_backend\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"m\n\x03\x46oo\x12\n\n\x02id\x18\x01 \x01(\x04\x12.\n\ncreated_at\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.Timestamp\x12*\n\x04name\x18\x05 \x01(\x0b\x32\x1c.google.protobuf.StringValueb\x06proto3'
  ,
...
_FOO = _descriptor.Descriptor(
  name='Foo',
  full_name='socialNet_backend.Foo',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='socialNet_backend.Foo.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='created_at', full_name='socialNet_backend.Foo.created_at', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='socialNet_backend.Foo.name', index=2,
...
Foo = _reflection.GeneratedProtocolMessageType('Foo', (_message.Message,), {
  'DESCRIPTOR' : _FOO,
  '__module__' : 'socialNet_backend_protobuf.foo_pb2'
  # @@protoc_insertion_point(class_scope:socialNet_backend.Foo)
  })
